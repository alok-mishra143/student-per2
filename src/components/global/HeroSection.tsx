...
export default function HeroGeometric({
  ...
  max-w-xl mx-auto px-4"
          ...
          >
              ...
              <Button className="px-6 py-2 rounded-full font-medium border border-neutral-700 dark:border-neutral-300 text-neutral-800 dark:text-neutral-200 bg-transparent hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all duration-300" onClick={handleclick}>
                Get Started
              </Button>
